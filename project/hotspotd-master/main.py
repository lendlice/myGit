...
template = 'xiademo' # added by chenren
IP_offset = 10	# added by chenren
...
#		break
	...
	ID = SSID[(len(template)):]	# added by chenren
	IP = '192.168.' + str(int(ID)+IP_offset) + '.1'	# added by chenren
