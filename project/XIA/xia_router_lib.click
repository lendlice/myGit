...
elementclass XIALineCard {
	...
	// input[0]: a packet arriving from the network // from device 
	// input[1]: a packet arriving from the higher stack (i.e. router or end host)  // e.g. routing core
